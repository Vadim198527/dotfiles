return {
	{
		...
		config = function()
            ...
            vim.keymap.set("n", "<leader>sw", ':lua MiniSessions.select("write")<cr>', {noremap = true, silent = true})
            vim.keymap.set("n", "<leader>sl", ':lua MiniSessions.select("read")<cr>', {noremap = true, silent = true})
            vim.keymap.set("n", "<leader>sd", ':lua MiniSessions.select("delete")<cr>', {noremap = true, silent = true})
		end,
	},
}
